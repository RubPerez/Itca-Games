...
import org.z.juegos.controller.SolicitudFacade;
...
public class SolicitudController {
    ...
    @EJB private org.z.juegos.controller.SolicitudFacade ejbFacade;
    ...
    public static class SolicitudControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Solicitud) {
                ...
                return getStringKey(o.getSlcCorr());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: "+SolicitudController.class.getName());
            }
        }
