...
import org.z.juegos.controller.CargoFacade;
...
public class CargoController {
    ...
    @EJB private org.z.juegos.controller.CargoFacade ejbFacade;
    ...
    public static class CargoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Cargo) {
                ...
                return getStringKey(o.getCrgCorr());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: "+CargoController.class.getName());
            }
        }
