...
import org.z.juegos.controller.VentaFacade;
...
public class VentaController {
    ...
    @EJB private org.z.juegos.controller.VentaFacade ejbFacade;
    ...
    public static class VentaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Venta) {
                ...
                return getStringKey(o.getVntCorr());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: "+VentaController.class.getName());
            }
        }
